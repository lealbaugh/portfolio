...
ssh_user       = "lea@instamatique.com"
ssh_port       = "22"
document_root  = "~/instamatique.com/portfolio"
rsync_delete   = false
...
desc "Begin a new project in #{source_dir}/#{posts_dir}"
task :new_project, :title, :preview do
  title = get_stdin("Enter project title: ")
  preview = get_stdin("Enter name of preview image: ")
